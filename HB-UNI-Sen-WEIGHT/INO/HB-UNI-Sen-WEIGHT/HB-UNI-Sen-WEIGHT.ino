...
#define LED_PIN            4
#define HX711_SCK_PIN      A6
#define HX711_DOUT_PIN     A7
...
class MeasureChannel : public Channel<Hal, UList1, EmptyList, List4, PEERS_PER_CHANNEL, UList0>, public Alarm {
  ...
  public:
    ...
    virtual void trigger (__attribute__ ((unused)) AlarmClock& clock) {
      ...
      if (msgcnt % 20 == 1) device().sendPeerEvent(msg, *this); else device();
      sysclock.add(*this);
    }
...
#ifdef USE_LCD
      lcd.setCursor(0, 2);
      lcd.print("LBAT Limit: " + String(this->getList0().lowBatLimit()));
      lcd.setCursor(0, 3);
      lcd.print("Sendeintervall: " + String(this->getList0().Sendeintervall()));
#endif
    }
};
